...
export const AUDIT_ACTIONS = Object.freeze({
  ...
  PULSE_DURING_CHECKPOINT_STATUS_UPDATE: 'pulse.during_checkpoint.status_update',
  ...
  CAMPAIGN_STAGE_CREATE: 'campaign.stage.create',
  CAMPAIGN_STAGE_UPDATE: 'campaign.stage.update',
  CAMPAIGN_STAGE_DELETE: 'campaign.stage.delete',
  QUIZ_CREATE: 'quiz.create',
  QUIZ_UPDATE: 'quiz.update',
  QUIZ_DELETE: 'quiz.delete',
  QUIZ_CAMPAIGN_LINK: 'quiz.campaign.link',
  QUIZ_CAMPAIGN_UNLINK: 'quiz.campaign.unlink',
  QUIZ_ENTRIES_IMPORT: 'quiz.entries.import',
